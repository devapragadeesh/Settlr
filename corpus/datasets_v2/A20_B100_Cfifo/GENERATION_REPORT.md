...
|---|---|---|
| A pool size | 20 | mean 18.5, sizes [1, 27, 19, 18, 12, 26, 20, 22, 24, 19, 21, 13] |
| B attestation coverage | 1 | 12/12 |
| C selection rule | fifo_under_cap | fifo_under_cap (phi=9/10) |

seed `20260919`, committed before generation.
...
- posting lag histogram (days): {0: 4, 1: 3, 2: 3, 5: 2}
- reference gaps: min 3, max 39 (a dense sequence would be a counter minted for this file)
